...
module rotate_clockwise (
  ...
  // output has rotation add 1 (clockwise) and coordinate
...
// testbench for rotate_clockwise
module rotate_clockwise_testbench();
  logic           clk, enable, valid;
  tetromino_ctrl  t;
  tetromino_ctrl  t_out;
  logic           isFailed, done;

  rotate_clockwise dut (.*);
